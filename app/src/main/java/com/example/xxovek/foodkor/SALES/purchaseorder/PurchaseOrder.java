 ...
 */
public class PurchaseOrder extends Fragment implements MyRecyclerViewAdapter.ItemClickListener{
    public int i;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.length()==0 || response.toString().equals("{}") || response.toString().equals("[]")){
                            ...
                            Toast.makeText(getContext(), "Unable to fetch purchase order data"+response.toString(), Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(getContext(), n.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                adapter.setClickListener(PurchaseOrder.this);
    ...
    public void onItemClick(View view, int position) {
        ...
        Toast.makeText(getContext(), "Id Of Supplier  " + user_id1.toString() + " on row number " + position, Toast.LENGTH_SHORT).show();
