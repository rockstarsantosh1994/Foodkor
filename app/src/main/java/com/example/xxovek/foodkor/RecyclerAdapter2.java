...
public class RecyclerAdapter2 extends RecyclerView.Adapter<RecyclerAdapter2.ViewHolder> {
    ...
    private static MyRecyclerViewAdapter.ItemClickListener mClickListener;
    ...
    RecyclerAdapter2(Context context, List<String> data1, List<String> data2, List<String> data3, List<String> data4, List<String> data5,
    ...
    public RecyclerAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.recyclerview_roww, parent, false);
